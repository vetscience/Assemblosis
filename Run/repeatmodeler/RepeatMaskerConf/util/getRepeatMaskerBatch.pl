...
#  ChangeLog:
#
#    $Log: getRepeatMaskerBatch.pl,v $
#    Revision 1.16  2017/02/01 21:01:57  rhubley
...
#  place this string into the $Name: open-4-0-7 $ space below
...
#  $Name: open-4-0-7 $ macro will be blank and thus we use
#  this as the development version.
#
my $CVSTag = '$Name: open-4-0-7 $';
my $version;
